...
public class VideoServiceImpl implements IVideoService {
    ...
    @Override
    public List<TVideo> getAllPassVideo() {
        return videoMapper.getAllPassVideo();
    }
    ...
    @Override
    public int updateLevel(Integer level, Long videoId) {
        return videoMapper.updateLevel(level,videoId);
    }
    ...
    @Override
    public List<TVideo> getNewVideo() {
        return videoMapper.getNewVideo();
    }
}
